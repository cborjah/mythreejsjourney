...
void main()
{
    ...
    float fresnel = dot(viewDirection, vNormal) + 1.0; // The dot product returns 1 if the two vectors are parallel to each other, 0 if they're perpendicular, and -1 if they are in opposite directions.
